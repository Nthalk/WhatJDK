...
public class JdkVersion {
    ...
    public static final JdkVersion JDK_1_4 = new JdkVersion("Java14", 48, 5);
    public static final JdkVersion JDK_1_3 = new JdkVersion("Java13", 47, 4);
    public static final JdkVersion JDK_1_2 = new JdkVersion("Java12", 46, 3);
    public static final JdkVersion JDK_1_1 = new JdkVersion("Java11", 45, 2);
    ...
    public static JdkVersion parse(Object maxJdkArgument) {
        ...
        throw new IllegalArgumentException("Unknown jdk version specifier: " + maxJdkArgument + " please use either an integer or the correct name");
    }
